...
--bash
java -cp "path/to/jdbc/driver.jar:path/to/project/bin" com.database.JoinSizeEstimator <databaseURL> <table1> <table2>
...
![image](https://github.com/Poojan912/Assignment-5-Software/assets/104124712/71ab5505-ccdf-41cc-9c11-dd839f889146)
